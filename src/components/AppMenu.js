...
function AppMenu(props) {
  ...
  return (
    ...
    >   
        ...
        <Typography variant='h6' fontWeight='fontWeightMedium' marginBottom='1em' >Eva Smith</Typography>
        <YellowButton marginBottom='1em' width='90%'>Download report as PDF</YellowButton>
